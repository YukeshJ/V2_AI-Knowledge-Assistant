...
export default function ProjectManagerDashboard() {
  ...
  const featureAccessRef = useRef(null);
  ...
  const greeting = getGreetingData(user?.username || "Project Manager");
      ...
      <main className="admin-main">
        <header className="admin-topbar">
          <div style={{display: 'flex', alignItems: 'center', gap: '12px'}}>
             ...
             <div>
               <p className="eyebrow">Project Manager Operational View</p>
               <h1>PM Dashboard</h1>
             </div>
          </div>
        ...
        <div id="feature-access" className="section-bottom-margin" ref={featureAccessRef}>
          <FeatureAccess scrollTo={scrollTo} refs={refs} />
        </div>
